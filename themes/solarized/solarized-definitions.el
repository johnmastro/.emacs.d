    ...
    (let ((back base03))
      ...
      (let ((bg-back   `(:background ,back))
        ...
        `(( ;; basic
           ...
           (magit-hash ((t (,@fg-yellow))))
           (magit-tag ((t (,@fg-yellow))))
           (magit-filename ((t (:inherit magit-hash))))
           (magit-branch-remote ((t (,@fg-green))))
           (magit-branch-local ((t (,@fg-blue))))
           (magit-branch-current ((t (:inherit magit-branch-local :box t))))
           (magit-head ((t (:inherit magit-branch-local))))
           (magit-refname ((t (:inherit magit-hash))))
           (magit-refname-stash ((t (:inherit magit-hash))))
           (magit-refname-wip ((t (:inherit magit-hash))))
           (magit-signature-good ((t (,@fg-green))))
           (magit-signature-bad ((t (,@fg-red))))
           (magit-signature-untrusted ((t (,@fg-cyan))))
           (magit-cherry-unmatched ((t (,@fg-cyan))))
           (magit-cherry-equivalent ((t (,@fg-magenta))))
           ;; magit-section
           (magit-section-heading ((t (,@fg-base03 ,@bg-base0))))
           (magit-section-highlight ((t (:inherit highlight))))
           ;; magit-diff
           (magit-diff-file-heading ((t (:inherit default ,@fmt-bold))))
           (magit-diff-file-heading-highlight ((t (:inherit (highlight magit-diff-file-heading) ,@fmt-bold))))
           (magit-diff-file-heading-selection ((t (:inherit magit-diff-file-heading-highlight ,@fg-orange))))
           (magit-diff-hunk-heading ((t (:inherit diff-hunk-header ,@fmt-bold))))
           (magit-diff-hunk-heading-highlight ((t (:inherit (highlight magit-diff-hunk-heading) ,@fmt-bold))))
           (magit-diff-hunk-heading-selection ((t (:inherit magit-diff-hunk-heading-highlight ,@fg-orange))))
           (magit-diff-lines-heading ((t (,@bg-orange ,@fg-base3))))
           ...
           (magit-diffstat-added ((t (,@fg-green))))
           (magit-diffstat-removed ((t (,@fg-red))))
           ;; magit-log
           (magit-log-author ((t (,@fg-orange))))
           (magit-log-date ((t (:inherit magit-diff-hunk-heading))))
           (magit-log-graph ((t (:inherit default))))
           (magit-reflog-commit ((t (,@fg-yellow))))
           (magit-reflog-amment ((t (,@fg-orange))))
           (magit-reflog-checkout ((t (,@fg-cyan))))
           (magit-reflog-reset ((t (,@fg-red))))
           (magit-reflog-rebase ((t (,@fg-green))))
           (magit-reflog-cherry-pick ((t (,@fg-violet))))
           (magit-reflog-remote ((t (,@fg-blue))))
           (magit-reflog-other ((t (,@fg-magenta))))
           ;; magit-blame
           (magit-blame-heading ((t (,@bg-base3 ,@fg-base02))))
           ;; magit-process
           (magit-process-ok ((t (,@fg-green))))
           (magit-process-ng ((t (,@fg-red))))
           ;; magit-sequence
           (magit-sequence-stop ((t (,@fg-green))))
           (magit-sequence-part ((t (,@fg-yellow))))
           (magit-sequence-head ((t (,@fg-blue))))
           (magit-sequence-drop ((t (,@fg-red))))
           ;; magit-bisect
           (magit-bisect-good ((t (,@fg-green))))
           (magit-bisect-skip ((t (,@fg-yellow))))
