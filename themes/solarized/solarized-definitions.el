    ...
    (let ((back base03))
      ...
      (let ((bg-back   `(:background ,back))
        ...
        `(( ;; basic
           ...
           ;; TODO: Make these better and add the rest
           (magit-dimmed ((t (:inherit font-lock-comment-face))))
           (magit-hash ((t (,@fg-orange))))
           ...
           (magit-diff-hunk-heading ((t (:inherit magit-section-heading))))
           (magit-diff-hunk-heading-highlight ((t (:inherit magit-section-heading ,@fmt-bold))))
           (magit-diff-context-highlight ((t (:inherit hl-line))))
           (magit-diff-added ((t (:inherit diff-added))))
           (magit-diff-added-highlight ((t (:inherit magit-diff-added ,@bg-base02))))
           (magit-diff-removed ((t (:inherit diff-removed))))
           (magit-diff-removed-highlight ((t (:inherit magit-diff-removed ,@bg-base02))))
